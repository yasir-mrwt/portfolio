...
import { Github, ExternalLink, ArrowUpRight, Sparkles, Zap, Lock, Users, BarChart3, Mail, Shield } from 'lucide-react';
...
const ProjectsShowcase = () => {
  ...
  const projects = [
    {
      ...
      description: "A comprehensive MERN stack platform revolutionizing academic collaboration with real-time features, secure authentication, and intelligent resource management.",
      longDescription: "Built a production-ready platform serving students with JWT authentication, Google OAuth integration, automated email verification, role-based access control, and an admin approval system with automated notifications.",
      ...
      highlights: [
        { icon: <Lock className="w-5 h-5" />, text: "JWT & OAuth Authentication" },
        { icon: <Users className="w-5 h-5" />, text: "Real-time Group Chats" },
        { icon: <Shield className="w-5 h-5" />, text: "Role-Based Access Control" },
    ...
    },
    {
      ...
      description: "Intelligent job application tracking system powered by FastAPI, delivering real-time analytics and comprehensive application lifecycle management.",
      longDescription: "Designed and implemented a full-stack tracking system with Python FastAPI backend, JWT authentication, RESTful APIs, and a modern React interface featuring status management, notes, deadlines, and analytics.",
    ...
    },
    {
      ...
      description: "Modern e-commerce solution with seamless user experience, robust cart management, and secure payment processing infrastructure.",
      longDescription: "Developed a complete e-commerce ecosystem using Node.js and Express, featuring comprehensive user authentication, dynamic product catalogs, intelligent cart management, and streamlined order processing.",
    ...
    },
    {
      ...
      description: "Comprehensive pet care management system with advanced role-based authorization and structured database architecture.",
      longDescription: "Created a full-stack platform using Node.js, Express, and MySQL with sophisticated user authentication, role-based authorization, admin dashboard, and structured database management for pet care services.",
      ...
      highlights: [
        { icon: <Shield className="w-5 h-5" />, text: "Role-Based Authorization" },
  ...
  return (
    <div id="projects" className="min-h-screen bg-slate-950 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-6 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-6">
            <Sparkles className="w-4 h-4 text-cyan-400" />
            <span className="text-sm text-gray-300 font-medium tracking-wide">PORTFOLIO</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8">
            <div className="relative group">
              <div className={`absolute inset-0 bg-gradient-to-r ${currentProject.gradient} blur-3xl opacity-30 group-hover:opacity-50 transition-opacity duration-700`}></div>
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center gap-3 mb-3">
                    {currentProject.stats.map((stat, idx) => (
                      <div key={idx} className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-bold text-gray-400 tracking-wider uppercase">Technology Stack</h4>
          ...
          <div className="space-y-8">
            <div>
              <div className="inline-block px-4 py-1.5 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-4">
                <span className="text-sm text-gray-400">{currentProject.tagline}</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {currentProject.highlights.map((highlight, idx) => (
                ...
                >
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${currentProject.gradient} text-white group-hover/highlight:scale-110 transition-transform duration-300`}>
                    {highlight.icon}
                  </div>
            ...
            <div className="flex gap-4 pt-4">
              <button className={`flex-1 group/btn flex items-center justify-center gap-3 px-8 py-5 bg-gradient-to-r ${currentProject.gradient} rounded-2xl font-bold text-white text-lg shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105`}>
